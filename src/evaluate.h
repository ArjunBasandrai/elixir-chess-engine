...
namespace elixir {
    ...
    namespace eval {
        ...
        constexpr EvalScore material_score[7] = {S(95, 132), S(293, 395), S(325, 390), S(453, 706), S(984, 1303), S(0, 0), S(0, 0)};
        ...
        const int knight_mobility[9] = {S(23, 12), S(40, 9), S(47, 14), S(51, 9), S(55, 14), S(53, 20), S(51, 22), S(49, 23), S(52, 19)};
        const int bishop_mobility[14] = {S(3, -60), S(12, -37), S(21, -28), S(23, -16), S(31, -1), S(39, 13), S(46, 18), S(50, 25), S(50, 34), S(53, 32), S(56, 31), S(60, 31), S(59, 36), S(92, 17)};
        const int rook_mobility[15] = {S(-16, -16), S(-4, 0), S(0, 2), S(5, 5), S(5, 12), S(13, 14), S(17, 16), S(25, 18), S(29, 28), S(35, 31), S(41, 33), S(48, 35), S(48, 41), S(54, 47), S(57, 43)};
        const int queen_mobility[28] = {S(-69, -48), S(-69, -118), S(-78, -45), S(-75, -25), S(-72, -22), S(-69, -18), S(-64, -12), S(-66, 11), S(-63, 18), S(-61, 22), S(-60, 34), S(-60, 41), S(-59, 50), S(-58, 56), S(-56, 62), S(-56, 69), S(-53, 73), S(-56, 85), S(-52, 91), S(-50, 91), S(-38, 89), S(-35, 90), S(-34, 93), S(-28, 93), S(-2, 72), S(59, 49), S(54, 49), S(206, -16)};
