...
namespace elixir::attacks {
    ...
    constexpr Bitboard get_pawn_attacks(Color c, Square sq) noexcept { return pawn_attacks[static_cast<int>(c)][static_cast<int>(sq)]; }
    constexpr Bitboard get_knight_attacks(Square sq) noexcept { return knight_attacks[static_cast<int>(sq)]; }
    constexpr Bitboard get_king_attacks(Square sq) noexcept { return king_attacks[static_cast<int>(sq)]; }
