...
namespace elixir {
    ...
    class History {
      public:
        ...
        void clear();
        void update_history(Square from, Square to, U8 depth, MoveList &bad_quiets);
        ...
        void update_chs(move::Move& move, search::SearchStack *ss, MoveList &bad_quiets, U8 depth);
      ...
      private:
        int history_bonus(U8 depth) {
            return std::min(300 * depth - 150, 4000);
        }

        int history_malus(U8 depth) {
        ...
        void update_single_chs(move::Move& move, search::SearchStack *ss, U8 depth, bool is_bad_quiet);
    };
}