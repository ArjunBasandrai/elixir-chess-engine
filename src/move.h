...
namespace elixir::move {
    ...
    public:
        ...
        [[nodiscard]] constexpr Square get_to() const noexcept { return static_cast<Square>((m_move >> 6) & 0x3f); }
        [[nodiscard]] constexpr Piece get_piece() const noexcept { return static_cast<Piece>((m_move >> 12) & 0xf); }
        [[nodiscard]] constexpr Flag get_flag() const noexcept { return static_cast<Flag>((m_move >> 16) & 0x7); }
        ...
        [[nodiscard]] constexpr bool is_en_passant() const noexcept { return get_flag() == Flag::EN_PASSANT; }
        [[nodiscard]] constexpr bool is_castling() const noexcept { return get_flag() == Flag::CASTLING; }
        [[nodiscard]] constexpr bool is_promotion() const noexcept { return get_flag() == Flag::PROMOTION || get_flag() == Flag::CAPTURE_PROMOTION; }
