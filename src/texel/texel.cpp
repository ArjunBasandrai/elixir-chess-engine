...
namespace elixir::texel {
    void Tune::get_intial_parameters() {
        ...
        add_parameter_single(eval::knight_safety_attacker_bonus);
        add_parameter_single(eval::bishop_safety_attacker_bonus);
        add_parameter_single(eval::rook_safety_attacker_bonus);
        add_parameter_single(eval::queen_safety_attacker_bonus);
    }
