...
namespace elixir::texel {
    ...
    struct Trace {
        ...
        std::array<std::array<int, 2>, 8> passed_pawn_defended_bonus;
    };
    ...
    class Tune {
      public:
        ...
        void get_all_coefficients(TunerPosition &position) {
            ...
            get_coefficient_value_array<8>(position, trace.passed_pawn_defended_bonus);
        }
        ...
        void print_parameters(int epoch) {
            ...
            print_parameter_array<8>(ss, "passed_pawn_defended_bonus", index);
