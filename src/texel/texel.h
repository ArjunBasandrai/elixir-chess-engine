...
namespace elixir::texel {
    ...
    struct Trace {
        ...
        std::array<std::array<int, 2>, 64> supported_pawn_bonus;
    };
    ...
    class Tune {
      public:
        ...
        void get_all_coefficients(TunerPosition &position) {
            ...
            get_coefficient_value_array<64>(position, trace.supported_pawn_bonus);
        }
        ...
        void print_parameters(int epoch) {
            ...
            print_parameter_array<64>(ss, "supported_pawn_bonus", index);
