...
namespace elixir::texel {
    ...
    struct Trace {
        ...
        std::array<std::array<int, 2>, 14> pawn_shelter_table;
    };
    ...
    class Tune {
      public:
        ...
        void get_all_coefficients(TunerPosition &position) {
            ...
            get_coefficient_value_array<14>(position, trace.pawn_shelter_table);
        }
        ...
        void print_parameters(int epoch) {
            ...
            print_parameter_array<14>(ss, "pawn_shelter_table", index);
