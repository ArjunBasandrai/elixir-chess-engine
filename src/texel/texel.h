...
namespace elixir::texel {
    ...
    struct Trace {
        ...
        std::array<std::array<int, 2>, 8> isolated_pawn_penalty;
        ...
        std::array<int, 2> knight_safety_attacker_bonus;
        std::array<int, 2> bishop_safety_attacker_bonus;
        std::array<int, 2> rook_safety_attacker_bonus;
        std::array<int, 2> queen_safety_attacker_bonus;
    };
    ...
    class Tune {
      public:
        ...
        void get_all_coefficients(TunerPosition &position) {
            ...
            get_coefficient_value_array<8>(position, trace.isolated_pawn_penalty);
            ...
            get_coefficient_value_single(position, trace.knight_safety_attacker_bonus);
            get_coefficient_value_single(position, trace.bishop_safety_attacker_bonus);
            get_coefficient_value_single(position, trace.rook_safety_attacker_bonus);
            get_coefficient_value_single(position, trace.queen_safety_attacker_bonus);
        }
        ...
        void print_parameters(int epoch) {
            ...
            print_parameter_array<8>(ss, "isolated_pawn_penalty", index);
            ...
            print_parameter_single(ss, "knight_safety_attacker_bonus", index);
            print_parameter_single(ss, "bishop_safety_attacker_bonus", index);
            print_parameter_single(ss, "rook_safety_attacker_bonus", index);
            print_parameter_single(ss, "queen_safety_attacker_bonus", index);
