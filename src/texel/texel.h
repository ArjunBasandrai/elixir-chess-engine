...
namespace elixir::texel {
    ...
    struct Trace {
        ...
        std::array<std::array<int, 2>, 2> hanging_pawn_penalty;
    };
    ...
    class Tune {
      public:
        ...
        void get_all_coefficients(TunerPosition &position) {
            ...
            get_coefficient_value_array<2>(position, trace.hanging_pawn_penalty);
        }
        ...
        void print_parameters(int epoch) {
            ...
            print_parameter_array<2>(ss, "hanging_pawn_penalty", index);
