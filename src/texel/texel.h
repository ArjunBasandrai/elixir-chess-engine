...
namespace elixir::texel {
    ...
    struct Trace {
        ...
        std::array<std::array<int, 2>, 64> bishop_outpost_bonus;
    };
    ...
    class Tune {
      public:
        ...
        void get_all_coefficients(TunerPosition &position) {
            ...
            get_coefficient_value_array<64>(position, trace.bishop_outpost_bonus);
        }
        ...
        void print_parameters(int epoch) {
            ...
            print_parameter_array<64>(ss, "bishop_outpost_bonus", index);
