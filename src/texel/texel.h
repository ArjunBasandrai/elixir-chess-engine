...
namespace elixir::texel {
    ...
    struct Trace {
        ...
        std::array<std::array<int, 2>, 8> backward_pawn_penalty;
    };
    ...
    class Tune {
      public:
        ...
        void get_all_coefficients(TunerPosition &position) {
            ...
            get_coefficient_value_array<8>(position, trace.backward_pawn_penalty);
        }
        ...
        void print_parameters(int epoch) {
            ...
            print_parameter_array<8>(ss, "backward_pawn_penalty", index);
