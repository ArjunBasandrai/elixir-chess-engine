...
namespace elixir::texel {
    ...
    struct Trace {
        ...
        std::array<std::array<int, 2>, 8> pawn_storm_table;
    };
    ...
    class Tune {
      public:
        ...
        void get_all_coefficients(TunerPosition &position) {
            ...
            get_coefficient_value_array<8>(position, trace.pawn_storm_table);
        }
        ...
        void print_parameters(int epoch) {
            ...
            print_parameter_array<8>(ss, "pawn_storm_table", index);
