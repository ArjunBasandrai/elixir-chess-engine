...
inline vepi16 load_epi16(int num) {
    return _mm512_set1_epi16(num);
};
inline vepi32 load_epi32(int num) {
    return _mm512_set1_epi32(num);
};
// inline void store_epi16(void *memory_address, vepi16 vector) { _mm512_store_si512(memory_address,
// vector); }
...
inline vepi16 clip(vepi16 vector, int L1Q) {
    return _mm512_min_epi16(_mm512_max_epi16(vector, zero_epi16()), load_epi16(L1Q));
}
...
// inline void store_epi16(void *memory_address, vepi16 vector) { _mm256_store_si256(memory_address,
// vector); }
...
inline vepi16 clip(vepi16 vector, int L1Q) {
    return _mm256_min_epi16(_mm256_max_epi16(vector, zero_epi16()), load_epi16(L1Q));
}
