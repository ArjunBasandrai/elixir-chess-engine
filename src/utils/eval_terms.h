    ...
    const std::array<std::array<EvalScore, 64>, 6> psqt = {
        {{S(0, 0),     S(0, 0),     S(0, 0),     S(0, 0),     S(0, 0),    S(0, 0),    S(0, 0),
         ...
         {S(71, -100), S(48, -42),  S(75, -32),  S(-27, 4),   S(11, -5),   S(46, -1),   S(68, -8),
          ...
          S(61, -75)}}};
    const std::array<EvalScore, 9> knight_mobility  = {S(25, -4), S(44, -3), S(54, 2),
                                                       S(57, 0),  S(61, 2),  S(60, 7),
                                                       S(59, 8),  S(58, 8),  S(59, 4)};
    const std::array<EvalScore, 14> bishop_mobility = {S(6, -66),  S(14, -43), S(23, -37),
                                                       S(25, -26), S(33, -13), S(40, 0),
                                                       S(46, 4),   S(49, 11),  S(51, 18),
                                                       S(52, 17),  S(57, 15),  S(60, 16),
                                                       S(61, 20),  S(86, 5)};
    const std::array<EvalScore, 15> rook_mobility   = {S(-15, -28), S(-4, -11), S(0, -7),  S(4, -4),
                                                       S(4, 2),     S(13, 4),   S(17, 7),  S(26, 9),
                                                       S(30, 18),   S(37, 21),  S(43, 22), S(47, 27),
                                                       S(49, 33),   S(56, 36),  S(57, 34)};
    const std::array<EvalScore, 28> queen_mobility  = {
         S(-72, -3), S(-70, -90), S(-73, -57), S(-70, -41), S(-67, -41), S(-63, -32), S(-59, -25),
         S(-61, -4), S(-59, 6),   S(-56, 9),   S(-55, 21),  S(-55, 28),  S(-54, 37),  S(-52, 43),
         S(-50, 48), S(-49, 53),  S(-46, 58),  S(-49, 70),  S(-44, 75),  S(-43, 76),  S(-36, 78),
         S(-32, 80), S(-30, 80),  S(-18, 76),  S(-7, 65),   S(46, 49),   S(71, 34),   S(161, -4)};
